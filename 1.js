        ...
        function(e) {
            ...
            openChat: function(e, o, n) {
                ...
                r()) {
                    ...
                    return window.YDK_TASK_CACHE[t.id] = t,
                    workbench.im.uiutil.invoke(t.id, t.cmd, JSON.stringify(t.param)),
                    !0
                }
                return !1
            },
            getActiveUser: function(e, o) {
                o = o || function() {}
                ;
                var n = r();
                return !!n && (n.application.invoke({
            ...
            transferContact: function(e, o, n, t) {
                t = t || function() {}
                ;
                var i = r();
                return !!i && (i.application.invoke({
                    cmd: "transferContact",
                    param: {
                        contactID: "cntaobao" + e,
                        targetID: "cntaobao" + o,
                        reason: "其它"
                    },
                    success: n,
    ...
    function y(e) {
        ...
        return function o() {
            ...
            t.onmessage = function(e) {
                ...
                "active_user" == o.type && a.getActiveUser(function(e) {
                ...
                "open_chat" != o.type ? ("send" == o.type && a.send(o.buyer, o.message, function(e) {
                    t.send(JSON.stringify({
                        type: "open_chat",
                        id: o.guid,
                        code: "success",
                    ...
                    t.send(JSON.stringify({
                        ...
                        id: o.guid,
                        code: "error",
                        description: e.msg + ":" + e.sub_msg
                    }))
                }),
                "transfer" == o.type && (u("转接"),
                a.transferContact(o.buyer, o.seller, function(e) {
                    l("转接成功", e),
                    t.send(JSON.stringify({
                        type: "transfer",
                        id: o.guid,
